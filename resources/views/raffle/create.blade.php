                ...
                <form method="POST" action="{{ route('raffle.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="status" name="status"
                            ...
                            <option value="active" @selected(old('status') === 'active')>Active — tickets will be generated</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="total_tickets" name="total_tickets" type="number"
                                          min="1" max="100000"
                                          class="mt-1 block w-full"
                                          :value="old('total_tickets')" required />
                    ...
                    <div class="flex justify-end gap-3 mt-6">
                        ...
                        <x-primary-button>Create Raffle</x-primary-button>
                    </div>
